...
<body class="min-h-screen flex items-center justify-center bg-gradient-animated px-4">
    ...
    <div class="w-full max-w-md bg-white bg-opacity-90 rounded-3xl shadow-xl p-6 sm:p-8 opacity-0 animate-fadeInSlide"
        ...
        <p class="text-center text-gray-600 mb-6 sm:mb-8 text-sm sm:text-base">Masuk untuk melanjutkan ke
            <strong>LalokSumbar.id</strong></p>

        <!-- Flash Message Error -->
        @if ($errors->any())
            <div
                class="mb-4 bg-red-100 border border-red-400 text-red-700 p-3 rounded-lg border border-red-300 shadow-md transition-transform hover:scale-105 duration-200">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div>
                <label for="password_confirmation"
                    class="block text-gray-700 mb-1 font-medium text-sm sm:text-base">Konfirmasi Password</label>
