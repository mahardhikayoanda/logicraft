...
<body class="h-full">
            ...
            <div class="sidebar-content">
                ...
                <div class="p-4 flex items-center justify-between border-b border-slate-700">
                    <div class="flex items-center">
                        <div
                            class="sidebar-icon w-8 h-8 rounded-lg bg-sky-500 flex items-center justify-center text-white">
                            <i class="fas fa-building"></i>
                        </div>
                        <span class="logo-text font-bold text-lg ml-3">PropertiKu</span>
                    </div>
                ...
                <nav class="flex-1 overflow-y-auto p-2">
                    ...
                    <a href="{{ route('owner.properties.index') }}"
                        class="nav-item text-slate-200 hover:bg-slate-800 rounded-lg
                              {{ request()->routeIs('owner.properties.*') ? 'active' : '' }}">
                        <div class="sidebar-icon">
                            <i class="fas fa-home"></i>
                        </div>
                        <span class="nav-text">Properti</span>
                        <span class="tooltip">Properti</span>
                    </a>

                    <a href="{{ route('owner.reports.index') }}"
                        class="nav-item text-slate-200 hover:bg-slate-800 rounded-lg
                              {{ request()->routeIs('owner.reports.*') ? 'active' : '' }}">
                        <div class="sidebar-icon">
                ...
                <div class="p-4 border-t border-slate-700">
                    <div class="flex items-center mb-3">
                        ...
                        <div class="user-info ml-3">
                            ...
                            <div class="user-role text-xs text-slate-400">Owner</div>
                        </div>
                    </div>
        ...
        <div id="main-content" class="main-content">
            ...
            <header class="hidden md:flex items-center justify-between p-4 bg-white shadow-sm sticky top-0 z-40">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div
                        class="w-8 h-8 rounded-full bg-sky-100 flex items-center justify-center text-sky-600 font-medium">
                        {{ substr(Auth::user()->name, 0, 1) }}
                    </div>
                </div>
            </header>
    ...
    <div id="mobile-bottom-menu" class="mobile-bottom-menu md:hidden">
        <div class="px-2 pt-2 pb-4 space-y-1">
            <a href="{{ route('owner.dashboard') }}"
                class="mobile-menu-item {{ request()->routeIs('owner.dashboard') ? 'active' : '' }}">
                <i class="fas fa-chart-pie"></i>
                <span>Dashboard</span>
            </a>
            <a href="{{ route('owner.properties.index') }}"
                class="mobile-menu-item {{ request()->routeIs('owner.properties.*') ? 'active' : '' }}">
                <i class="fas fa-home"></i>
                <span>Properti</span>
            </a>
            <a href="{{ route('owner.reports.index') }}"
                class="mobile-menu-item {{ request()->routeIs('owner.reports.*') ? 'active' : '' }}">
                <i class="fas fa-file-invoice-dollar"></i>
                <span>Laporan</span>
            </a>
