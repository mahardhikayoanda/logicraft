...
@section('content')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <!-- Form content -->
            <form method="POST" action="{{ route('resepsionis.promotions.update', $promotion->id) }}"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 transition"
                            placeholder="Deskripsi lengkap promosi">{{ old('description', $promotion->description) }}</textarea>
                    </div>
                    ...
                    <div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative w-64 h-40 border border-gray-300 rounded-md overflow-hidden">
                                    <img src="{{ asset('storage/' . $promotion->image_path) }}"
                                        alt="Current promotion image" class="w-full h-full object-cover">
                                    <button type="button"
                                ...
                                <p class="text-xs text-gray-500 mt-1">Centang di bawah untuk menghapus gambar ini</p>
                        ...
                        <div id="image-preview-container" class="hidden mt-4">
                            <p class="text-sm text-gray-500 mb-2">Pratinjau gambar baru:</p>
                            <div class="relative w-64 h-40 border border-gray-300 rounded-md overflow-hidden">
